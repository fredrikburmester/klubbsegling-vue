        ...
        <div class="fixed top-0 w-screen left-0 navbar shadow-lg bg-base-100 text-base-content z-50">
            ...
            <div class="flex-none hidden px-2 mx-2 sm:flex">
                <div class="flex items-stretch">
                    ...
                    <router-link id="profile" class="btn btn-sm rounded-btn mx-2" :class="activeButton('anchor')" to="/clubs"><font-awesome-icon icon="user" class="mr-2" />Klubbar</router-link>
